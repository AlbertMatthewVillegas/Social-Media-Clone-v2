...
export default function SettingsSidebar() {
  ...
  return (
    <>
    <div className="w-100 shrink-0" aria-hidden="true" />
    <div className="min-h-screen fixed flex w-100 overflow-y-auto">
...
const sections: Section[] = [
    ...
    },
    {
        ...
        items: [
            { icon: User, text: "Edit profile", route: "/accounts/edit", status: false },
